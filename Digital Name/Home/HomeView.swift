...
struct HomeView: View {
    ...
    // MARK: - Body
    var body: some View {
        let title2 = Font.custom("SoletoTK-Medium", size: 50)
        let title3 = Font.custom("SoletoTK-Medium", size: 40)
        let title = Font.custom("SoletoTK-Bold", size: 45)
        let largeTitle = Font.custom("SoletoTK-Bold", size: 70)
        let title17 = Font.custom("SoletoTK-Bold", size: 37)
        let title35 = Font.custom("SoletoTK-Bold", size: 55)
        let welcomeFont = Font.custom("SoletoTK-Medium", size: 150)
            ...
            ScrollView {
                VStack {
                    ...
                    if geometry.size.width > geometry.size.height {
                        ...
                        .frame(minHeight: geometry.size.height - CGFloat(topPadding))
                    } else {
                        /// PORTRAIT
                        VStack(alignment: .leading) {
                            VStack(alignment: .leading) {
